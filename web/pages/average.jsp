    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="collapsing-navbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="average.jsp">Average mark</a></li>
...
<div class="container" role="main">
    <div class="page-header">
        <h1>Show average mark for faculty</h1>
    </div>
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <c:if test="${not empty result}">
                <div>
                    <h2>Average mark: <span class="label label-default"><fmt:formatNumber type="number" maxFractionDigits="2" value="${result}" /></span></h2>
                </div>
            </c:if>
        </div>
    </div>
